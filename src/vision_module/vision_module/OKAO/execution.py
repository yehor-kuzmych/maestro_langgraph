...
def main():
    ...
    try:
        ...
        while True:
            ...
            print (hvc_tracking_result.faces)
                    #print (hvc_tracking_result.faces[0].expression.neutral)
                    #print (hvc_tracking_result.faces[0].expression.happiness)
                    #print (hvc_tracking_result.faces[0].expression.surprise)
                    #print (hvc_tracking_result.faces[0].expression.anger)
                    #print (hvc_tracking_result.faces[0].expression.sadness)
                    #print (hvc_tracking_result.faces[0].expression.neg_pos)
